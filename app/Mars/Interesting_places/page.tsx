...
import massive_way_tours_1 from '@/widgets/way_tours/Mars/massive_mars_tours_1';
import massive_way_tours_2 from '@/widgets/way_tours/Mars/massive_mars_tours_2';
import massive_way_tours_3 from '@/widgets/way_tours/Mars/massive_mars_tours_3';
import massive_way_tours_4 from '@/widgets/way_tours/Mars/massive_mars_tours_4';
const Actions = () => {
  return (
    <div className={style.Block}>
      <div className={style.Block_row}>
        ...
        <div className={style.cards}>
          ...
          <button className={style.select_way}><Link href="/Mars_select_way">
