...
import Clutch from "@/public_img/Cave/Cave_buy/Clutch.png";
import Moo from "@/public_img/Cave/Cave_buy/Moos.png";
import Uvan from "@/public_img/Cave/Cave_buy/Uvan.png";
    ...
    <div className={style.Block}>
      <div className={style.Block_row}>
        ...
        <div className={style.Region_and_service}>
          <div className={style.Region_and_service_row}>
            <div className={style.Region}>
              <h3>Регион:<span className={style.blue}>Зюраткуль</span></h3>
              <h3>Наименование маршрута:<span className={style.blue}>Хребет москаль</span></h3>
              <h3>Выбранные зоны:</h3>
              <div className={style.Images}>
                <Image src={Clutch} alt='Image' />
                <Image src={Uvan} alt='Image' />
                <Image src={Moo} alt='Image' />
              </div>
              <h3>Предполагаемая дата похода:10.05.2024</h3>
              <div className={style.Cost_and_people}>
                <h3>Кол-во человек:20</h3>
                <h3>Стоимость:27 тыс.руб.</h3>
              </div>
            </div>
       ...
       <div className={style.email_div}>
        ...
        <h2>Итоговая стоимость:30 тыс. руб.</h2>
        </div> 
